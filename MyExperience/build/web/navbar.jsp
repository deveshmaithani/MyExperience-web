    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="#"><span class="fa fa-users"></span> Interview</a>
            <a class="dropdown-item" href="#"><span class="fa fa-pencil"></span> Tech Blog</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="#"><span class="fa fa-bullhorn"></span> Company</a>
        </div>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
          <a class="nav-link" href="login_page.jsp"><span class="fa fa-unlock-alt"></span> Login</a>
      </li>
      <li class="nav-item">
